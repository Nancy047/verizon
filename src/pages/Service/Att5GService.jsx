...
import { useStoredData } from "../../store";
...
const Att5GService = () => {
  ...
  //   const { storedData, updateStoredData } = useStoredData();
  ...
  const handleRadioChange = (event, value, field) => {
  ...
  const insertService = () => {
    ...
    if (
      ...
      if (
        ...
        dispatch(removeService({ key: formData }));
