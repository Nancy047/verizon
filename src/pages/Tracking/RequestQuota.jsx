...
import OrderTracking from "../../assets/images/staroutline.svg";
...
const RequestQuota = () => {
  ...
  const serviceMenuItems = storedData?.selected_services
  ...
  const [selectedTracking, setSelectedTracking] = useState("transfer_status");
  const [currentTracking, setCurrentTracking] = useState(trackingMenuItems[2]);
                  ...
                  <div className="requestquote-checkmenu d-flex justify-between">
                    <div className="d-flex">
                      ...
                      <div className="pl-1 mY-auto">
                        1/{serviceMenuItems.length} Items Selected
                      </div>
                    </div>
                    <div className="d-flex">
