...
const ApiDesc = ({ specificCard, onVerifyClick, emptyselected }) => {
  ...
  const handleVerifyClick = (selcard) => {
    onVerifyClick(specificCard.id, selcard);
    emptyselected();
  };
  ...
  const updateBreadCrumbFlow = (status, title) => {
    setBreadCrumbFlow((prevBreadCrumbFlow) => {
      return prevBreadCrumbFlow.map((breadcrumb) =>
        breadcrumb.id === 2
  ...
  const handlePost = async () => {
    try {
      const api =
        "http://35.225.170.236:8085/tmf-api/accountManagement/v4/billFormat/getAll";
  ...
  return (
    <div>
      ...
      <div className="d-flex" style={{ height: "78vh" }}>
        ...
        <div className="drawer-body">
              ...
              <div className="categoryapi-desc-card">
                <div className="category-desc-left">
                  ...
                  <div className="cat_left_text-1">
                    ...
                    <div className="d-flex" style={{ fontSize: "14 px" }}>
                    ...
                    <div
                      className="d-flex"
                      style={{ flexDirection: "column", fontSize: "12px" }}
                    >
                      <Stack spacing={1}>
                        <Rating
                          name="half-rating"
                ...
                <div className="category-desc-right">
                  <div className="right-desc-text-1">{specificCard.desc}</div>
                  <div className="right-main-desc2">
                    <div className="d-flex">
                      <div className="right-api-desc-1">
                        <div className="d-flex">
                    ...
                    <div className="right-api-desc21 d-flex">
                      <Button
                        variant="contained"
          ...
          <div>
            ...
            {selectedStatus === "Overview" ? (
              <div className="api-desc-overview-1">
                <div className="api-desc-over-title">Product overview</div>
                <div className="api-desc-over-desc-1">
              ...
              <div className="api-desc-overview-1">
                <div className="api-desc-over-title">{specificCard.title}</div>
                <div className="api-desc-over-desc-1">
              ...
              <div className="api-desc-overview-12">
                <div className="endpoint-card-main">
                  <div className="endpoint-card1">
                    <div
                      className=""
              ...
              <div className="api-desc-overview-1">
                <div className="d-flex" style={{ height: "87%" }}>
                  ...
                  <div className="cat_right_line"></div>
                  <div className="api-desc-review123">
                    ...
                    <div className="api-desc-right-main">
                      ...
                      <div className="review-content-main-text1">
